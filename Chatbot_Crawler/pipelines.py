...
class ChatbotCrawlerPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, RelationshipsItem):
            ...
            try:
                ...
                sql = ''
                sql += str(
                    'INSERT INTO SinaWeibo.Tweets (`weibo_id`,`User_id`,`Content`,`Pubtime`,`Coordinates`,`Tools`,`Likes`,`Comments`,`Transfers`) ')
                sql += str(' Values(\'')
                sql += str(item['_id'])
            ...
            try:
                ...
                sql = ''
                sql += str(
                    'INSERT INTO SinaWeibo.Information (`User_id`,`NickName`,`Gender`,`Province`,`City`,`BriefIntroduction`,`Birthday`,`Num_Tweets`,`Num_Follows`,`Num_Fans`,`SexOrientation`,`Sentiment`,`VIPlevel`,`Authentication`,`URL`) ')
                sql += str(' Values(\'')
                sql += str(item['_id'])
